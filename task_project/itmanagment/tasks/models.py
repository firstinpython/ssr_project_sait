...
from project.models import ProjectsModel
from users.models import UsersModel
# Create your models here.

class TaskModel(models.Model):
    name_task = models.CharField(verbose_name="name_task",max_length = 120)
    description_task = models.CharField(verbose_name = "description_task")
    ...
    executor = models.ForeignKey(to = UsersModel,on_delete=models.CASCADE)
    ...
    date_of_deadline = models.DateField(verbose_name='date_of_deadline')
    resp_for_testing = models.ForeignKey(to=UsersModel,on_delete=models.CASCADE)
...
class PriorityTaskModel(models.Model):
    name_priority = models.CharField(verbose_name="name_priority")